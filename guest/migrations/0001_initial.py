    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('kategori_dituju', models.CharField(choices=[('Kepala Sekolah', 'Kepala Sekolah'), ('Wakil Kepala Sekolah', 'Wakil Kepala Sekolah') ,('Guru', 'Guru'), ('TU', 'TU'), ('Siswa', 'Siswa')], default='Siswa', max_length=20)),
